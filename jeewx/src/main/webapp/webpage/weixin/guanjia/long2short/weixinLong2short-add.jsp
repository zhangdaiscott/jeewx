  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinLong2shortController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="wxName" name="wxName" type="text" style="width: 150px" class="inputxt" datatype="*">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="longUrl" name="longUrl" type="text" style="width: 500px" class="inputxt" datatype="*">
							<span class="Validform_checktip"></span>
