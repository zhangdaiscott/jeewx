...
<!-- update-begin-author:taoYan date:20180312 for:增加菜单类型小程序类 -->
<t:dgCol field="type" treefield="src" title="菜单类型" replace="消息触发类_click,网页链接类_view,小程序类_miniprogram" width="100" ></t:dgCol>
<!-- update-end-author:taoYan date:20180312 for:增加菜单类型小程序类 -->
...
<!-- update-begin-author:taoYan date:20180312 for:dgToolBar-funname不用加括号 -->
...
<!-- update-end-author:taoYan date:20180312 for:dgToolBar-funname不用加括号  -->
</t:datagrid>
</div></div>
